...
cp.read('/Volumes/细雨带风/Learn_Code/Python_SearchPro/GUI_操作系统/Set/config.ini', encoding='utf-8')  # 读取配置文件
...
class SetConfig:
    ...
    def create(self, section, name, value):
        ...
        cp.write(open('/GUI_操作系统/Set/config.ini', "r+", encoding="utf-8"))
...
# print(Se('sure'))
#print(SetConfig().create('user','dxb1020913937@126.com','12345'))